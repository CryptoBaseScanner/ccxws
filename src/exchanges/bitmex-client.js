...
class BitmexClient extends BasicClient {
  ...
  _constructTrades(datum, market) {
    ...
    return new Trade({
      ...
      amount: homeNotional.toFixed(12),
  ...
  _constructLevel2Snapshot(data, market) {
    ...
    for (let datum of data) {
      ...
      if (this.constructL2Price) {
        this.l2PriceMap.set(datum.id, datum.price.toFixed(12));
      }

      // build the data point
      let point = new Level2Point(datum.price.toFixed(12), datum.size.toFixed(12), undefined, {
        id: datum.id,
      });
